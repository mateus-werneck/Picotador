...
public class MainActivity extends AppCompatActivity {
    ...
    public void StartCut (Uri path) {
        ...
        DialogCreate Aguarde = new DialogCreate("Aguarde", "Seu video está sendo picotado para caber no Stories.", android.R.drawable.ic_popup_sync, getApplicationContext());
            ...
            public void run() {
                ...
                recyclerView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (active) {
                        DialogCreate Pronto = new DialogCreate("Pronto", "Stories picotado!", android.R.drawable.ic_dialog_info, context);
